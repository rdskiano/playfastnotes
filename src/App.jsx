...
function MURScreen({ piece, pageImages, profile, savedExercise, tapPos, onBack, onDone }) {
  ...
  const exportPdf = () => {
    ...
    const html = '<!DOCTYPE html><html><head><meta charset="utf-8">'
      ...
      +'body{font-family:Helvetica,Arial,sans-serif;color:#000;margin:0;padding:0;width:7.5in;}'
      +'.title{font-size:14pt;font-weight:bold;margin:0 0 2px;}'
      +'.subtitle{font-size:8pt;color:#666;margin:0 0 8px;}'
      +'.ex-wrap{page-break-inside:avoid;break-inside:avoid;margin-bottom:2px;}'
      +'.ex-label{font-size:7pt;color:#999;margin:2px 0 0;font-family:monospace;}'
      +'.ex-staff{overflow:visible;}'
      ...
      +'try{ABCJS.renderAbc(div,abc,{scale:1.0,staffwidth:660,paddingright:10,paddingleft:10,paddingbottom:2,paddingtop:2,add_classes:true,wrap:{minSpacing:1.5,maxSpacing:2.6,preferredMeasuresPerLine:4}});}catch(e){}'
      +'});'
      +'});'
      +'<\/script></body></html>';
